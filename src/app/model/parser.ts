...
* BLOCK_CONTENT:= valur= NOTE | value= NOTE_GROUP
* NOTE:= SIMPLE_NOTE | TIMED_NOTE
* SIMPLE_NOTE:= NOTE_VALUE | SILENCE_SIGN
* TIMED_NOTE := duration= DURATION SIMPLE_NOTE
* NOTE_GROUP:= duration= DURATION GROUP_START block=BLOCK GROUP_END
* GROUP_START:= '\('
* GROUP_END:= '\)'
...
export type NOTE_1 = SIMPLE_NOTE;
export type NOTE_2 = TIMED_NOTE;
export type SIMPLE_NOTE = SIMPLE_NOTE_1 | SIMPLE_NOTE_2;
export type SIMPLE_NOTE_1 = NOTE_VALUE;
export type SIMPLE_NOTE_2 = SILENCE_SIGN;
...
export class Parser {
    ...
    public matchBLOCK_CONTENT_1($$dpth: number, $$cr?: ErrorTracker): Nullable<BLOCK_CONTENT_1> {
        return this.run<BLOCK_CONTENT_1>($$dpth,
            () => {
                let $scope$valur: Nullable<NOTE>;
                let $$res: Nullable<BLOCK_CONTENT_1> = null;
                if (true
                    && ($scope$valur = this.matchNOTE($$dpth + 1, $$cr)) !== null
                ) {
                    $$res = {kind: ASTKinds.BLOCK_CONTENT_1, valur: $scope$valur};
                }
                return $$res;
            });
    }
    ...
    public matchNOTE_1($$dpth: number, $$cr?: ErrorTracker): Nullable<NOTE_1> {
        return this.matchSIMPLE_NOTE($$dpth + 1, $$cr);
    }
    public matchNOTE_2($$dpth: number, $$cr?: ErrorTracker): Nullable<NOTE_2> {
        return this.matchTIMED_NOTE($$dpth + 1, $$cr);
    }
        ...
        return this.run<TIMED_NOTE>($$dpth,
            () => {
                ...
                if (true
                    ...
                    && this.matchSIMPLE_NOTE($$dpth + 1, $$cr) !== null
                ) {
                    $$res = {kind: ASTKinds.TIMED_NOTE, duration: $scope$duration};
                }
                return $$res;
            });
    }
